...
export function ArticuloCostosModal({
  ...
  if (margenPctNumber != null) {
    if (margenPctNumber >= RENTABILIDAD_THRESHOLDS.ALTA) {
      ...
      rentabilidadClasses = 'bg-emerald-500/10 text-emerald-800 border-emerald-200';
      ...
      rentabilidadClasses = 'bg-amber-500/10 text-amber-800 border-amber-200';
    } else {
      rentabilidadNivel = 'baja';
      rentabilidadLabel = 'Rentabilidad baja';
      rentabilidadDescripcion = 'Margen ajustado, revisar costos o precio.';
      rentabilidadClasses = 'bg-destructive/10 text-red-800 border-red-200';
    }
  }
            ...
            {!loading && !error && articulo && (
              <>
                ...
                <div className="space-y-1 text-center">
                  ...
                  <div className="mt-2 border-b border-border w-32 mx-auto" />
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    {detalle.length === 0 ? (
                      ...
                      <>
                        ...
                        <div className="hidden md:block max-h-[280px] lg:max-h-[320px] overflow-y-auto overflow-x-auto border border-border rounded-md">
                                ...
                                return (
                                  <tr key={idx} className={idx % 2 === 0 ? 'bg-card' : 'bg-muted/50'}>
                                    <td className="px-2 py-1.5 text-left">
                                      <span className="font-medium text-foreground">{norm.nombreIng}</span>
                                    </td>
                        ...
                        {costoTotal != null && (
                          <div className="flex justify-end mt-3">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-border bg-muted">
...
function ResumenItem({ label, value, emphasis }) {
  return (
    <div className="p-3 rounded-md border border-border bg-muted/40 flex flex-col gap-1">
      <span className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
        {label}
      </span>
      <span
        className={`text-sm ${
          emphasis ? 'font-bold text-foreground text-base' : 'font-semibold text-foreground'
        }`}
      >
        {value}
      </span>
