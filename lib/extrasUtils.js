...
export function getSufijoPresentacion(extras) {
  const arr = Array.isArray(extras) ? extras : [];
  const cuadruple = arr.find((e) => ES_HACELA_CUADRUPLE(e.nombre || e.adicional_nombre || e.name || ''));
...
/**
 * Sufijo de presentación para cocina: " DOBLE", " TRIPLE" o " CUADRUPLE".
